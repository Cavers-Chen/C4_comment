...
int* stack;           // stack
char* codedata;       // codedata segment
...
int main(int argc, char** argv)
{
    ...
    if (!(text = old_text = (int*)malloc(poolsize * sizeof(int)))) {
        printf("could not malloc(%d) for text area\n", poolsize);
        return -1;
    }
    if (!(codedata = (char*)malloc(poolsize * sizeof(char)))) {
        printf("could not malloc(%d) for data area\n", poolsize);
        return -1;
    }
    if (!(stack = (int*)malloc(poolsize * sizeof(int)))) {
